    ...
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden rounded-3xl border border-violet-500/30 bg-black">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-10">
        ...
        <header className="mb-8 text-center">
          ...
          <h1 className="mt-4 bg-gradient-to-r from-violet-300 via-fuchsia-200 to-amber-200 bg-clip-text text-3xl font-black leading-[1.4] tracking-tight text-transparent md:text-5xl md:leading-[1.4]">
            ระบบขอพร
          </h1>
