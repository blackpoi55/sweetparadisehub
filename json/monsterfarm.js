...
export const claim = {
  desc: "ใครก็ช่วยตีมอนตัวเดียวกันได้ แต่รางวัลจะไปที่ “คนที่เริ่มตีก่อน” (เจ้าของ) — ไม่มีแย่งฆ่า · บอสสนาม = ตีรวม ทุกคนที่ช่วยได้รางวัล",
  symbols: [
    { icon: "❤️", label: "มอนที่คุณจอง", badge: "ป้ายเขียว", note: "คุณเริ่มตีก่อน = จองไว้ ฆ่าแล้วรางวัลเข้าคุณ", mine: true },
    { icon: "🤝", label: "มอนของคนอื่น", badge: "ป้ายแดง", note: "คนอื่นจองไว้ ช่วยตีได้ รางวัลเข้าเจ้าของ", mine: false },
  ],
};
