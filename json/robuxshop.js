...
export const robuxItems = [
  ...
  // ===== บัตรระบบสกินเบ็ด (ไอเทมฟาร์ม เทรดได้ — ใช้ในแอพ 🎣 สกินเบ็ด) =====
  { id: "sp-rsstart", cat: "special", name: "🎴 บัตรการันตีสกินเบ็ด +0", desc: "1 ใบ = ได้สกินเบ็ดที่เลือกที่ +0 ทันที 100% (ไม่เสียวัตถุดิบ)", price: 1899, iconId: 103294967033174 },
  { id: "sp-rssafe", cat: "special", name: "🛡️ บัตรกันแตก ตีบวกเบ็ด", desc: "ตีบวกสกินเบ็ดแตก → ไม่เสียของเลย หักบัตรนี้แทน (+1 ถึง +30)", price: 699, iconId: 98856359995531 },

  // ===== 🏷️ บัตรตั้งแท็กแชท (ไอเทมฟาร์ม — ใช้ในแอพ 🏷️ แท็กแชท ในโทรศัพท์) =====
  { id: "sp-chattag", cat: "special", name: "🏷️ บัตรตั้งแท็กแชท", desc: "1 ใบ = ตั้งข้อความแท็กหน้าชื่อตัวเองในช่องแชทได้ 1 ครั้ง (เลือกสีได้)", price: 499, iconId: 126982669665217 },
];
