...
export const meta = {
  ...
  radius: 40, // RADIUS — รัศมีที่บัฟติดทุกคน (stud)
...
export const tips = [
  ...
  },
  {
    ...
    desc: `สุ่มพลาดแล้วย้อนกลับได้ด้วยบัตรกันแตก ${meta.undoCards} ใบ — ย้อนได้ครั้งเดียวต่อการสุ่ม 1 ครั้ง (ย้อนแล้วค่าเก่าหายไป) และถ้าสุ่มซ้ำ ค่าก่อนหน้าจะถูกทับ`,
  },
  {
